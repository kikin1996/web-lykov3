        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-body-small text-white text-opacity-80 hover:text-primary-teal transition-colors">
                  Domů
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/galerie" className="text-body-small text-white text-opacity-80 hover:text-primary-teal transition-colors">
                  Galerie
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/kontakt" className="text-body-small text-white text-opacity-80 hover:text-primary-teal transition-colors">
                  Kontakt
                </Link>
              </li>
            </ul>
