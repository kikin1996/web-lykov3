          ...
          <div id="interactive-map" className="luchnihaj-map-wrapper h-full w-full">
            ...
            >
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '1' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="1"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '2' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="2"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '3' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="3"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '4' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="4"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '5' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="5"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '6' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="6"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '7' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="7"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '8' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="8"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '9' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="9"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '10' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="10"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '11' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="11"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${selectedHouseId === '12' ? 'opacity-100' : 'hover:opacity-80'}`}
                  data-house-id="12"
